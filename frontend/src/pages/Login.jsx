      ...
      >
        ...
        <form className="auth-form" onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          <label style={{ display: "flex", flexDirection: "column", gap: "8px", fontWeight: "bold", color: "#14213D", fontSize: "15px" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input
                ...
                onFocus={(e) => { e.target.style.borderColor = "#3A86FF"; e.target.style.background = "#FFFFFF"; setMascotState("focused"); }}
          ...
          <label style={{ display: "flex", flexDirection: "column", gap: "8px", fontWeight: "bold", color: "#14213D", fontSize: "15px" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input
                ...
                style={{ width: "100%", padding: "16px 16px 16px 48px", borderRadius: "16px", border: "3px solid #14213D", background: "#F8FAFC", fontSize: "16px", outline: "none", transition: "all 0.2s", boxShadow: "inset 0px 4px 0px rgba(0,0,0,0.04)" }}
                onFocus={(e) => { e.target.style.borderColor = "#3A86FF"; e.target.style.background = "#FFFFFF"; setMascotState("hidden"); }}
                onBlur={(e) => { e.target.style.borderColor = "#14213D"; e.target.style.background = "#F8FAFC"; setMascotState("normal"); }}
              />
            </div>
          </label>

          {errorMsg && <div className="error-text" style={{ color: '#EF4444', background: "#FEF2F2", padding: "12px", borderRadius: "12px", border: "3px solid #FCA5A5", fontWeight: "bold" }}>{errorMsg}</div>}
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            style={{ width: '100%', display: "flex", justifyContent: "center", alignItems: "center", gap: "10px", padding: "16px", fontSize: "1.2rem", fontWeight: "bold", marginTop: "10px", borderRadius: "16px" }}
          >
            <LogIn size={22} />
        ...
        <div className="auth-footer" style={{ marginTop: "30px", textAlign: "center", color: "var(--text-muted)", fontSize: "1rem", fontWeight: "600" }}>
          New to Tripchain? <Link to="/signup" style={{ color: "#3A86FF", fontWeight: "bold", textDecoration: "none" }}>Create an account</Link>
        </div>
      </motion.div>
    </motion.div>
  );
